...
urls.extend(
    [
        ...
        # Ansible Resource
        path('ansible-resources/', views.ResourceViewSet.as_view(list_actions), name='resource-list'),
        re_path(r'ansible-resources/(?P<ansible_id>[0-9a-zA-Z\-]+)/$', views.ResourceViewSet.as_view(detail_actions), name='resource-detail'),
        re_path(
