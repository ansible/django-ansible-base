    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.ManyToManyField(help_text='The list of users who have authenticated from this authenticator', related_name='users', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
