    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                ...
                condition=(~models.Q(map_type='team') | models.Q(team__isnull=False) & models.Q(organization__isnull=False)),
            ),
            models.CheckConstraint(
                name="%(app_label)s_%(class)s_require_org_if_org_map",
                condition=(~models.Q(map_type='organization') | models.Q(organization__isnull=False)),
            ),
        ]
