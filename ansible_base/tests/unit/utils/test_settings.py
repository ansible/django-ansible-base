...
from ansible_base.utils.settings import SettingNotSetException, get_setting
...
@mock.patch("ansible_base.utils.settings.logger")
...
@override_settings(ANSIBLE_BASE_SETTINGS_FUNCTION='ansible_base.tests.unit.utils.test_settings.setting_getter_function')
