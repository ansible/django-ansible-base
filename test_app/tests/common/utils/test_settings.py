...
from ansible_base.common.utils.settings import SettingNotSetException, get_setting
...
@mock.patch("ansible_base.common.utils.settings.logger")
...
@override_settings(ANSIBLE_BASE_SETTINGS_FUNCTION='test_app.tests.common.utils.test_settings.setting_getter_function')
