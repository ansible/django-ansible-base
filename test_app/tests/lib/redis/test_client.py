...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('redis://my_mom:her_pass@home.com:1234/1', 'home.com', 1234, 'my_mom', 'her_pass', 1),
        ('redis://my_mom:her_pass@home.com/1', 'home.com', 6379, 'my_mom', 'her_pass', 1),
        ('redis://my_mom@home.com/', 'home.com', 6379, 'my_mom', None, 0),
        ('redis://:her_pass@home.com/', 'home.com', 6379, None, 'her_pass', 0),
        ('redis://home.com:1234/a', 'home.com', 1234, None, None, 0),
    ],
)
