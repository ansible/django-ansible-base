...
class TestCrossOrgTeamRoleAssignment:
    @override_settings(ALLOW_LOCAL_ASSIGNING_JWT_ROLES=True, ANSIBLE_BASE_ALLOW_TEAM_ORG_MEMBER=True, ORG_ADMINS_CAN_SEE_ALL_USERS=True)
    def test_org_admin_can_assign_org_role_to_cross_org_team(self, user, user_api_client, organization, org_admin_rd, org_member_rd):
        ...
        org-level role to a team from another org when ORG_ADMINS_CAN_SEE_ALL_USERS=True."""
        org_a = organization
    ...
    @override_settings(ALLOW_LOCAL_ASSIGNING_JWT_ROLES=True, ANSIBLE_BASE_ALLOW_TEAM_ORG_MEMBER=True, ORG_ADMINS_CAN_SEE_ALL_USERS=False)
    def test_org_admin_cannot_assign_org_role_to_cross_org_team_when_setting_disabled(self, user, user_api_client, organization, org_admin_rd, org_member_rd):
        """When ORG_ADMINS_CAN_SEE_ALL_USERS=False the cross-org team is not visible,
    ...
    def test_non_admin_cannot_assign_org_role_to_cross_org_team(self, user, user_api_client, organization, org_member_rd):
        ...
        The cross-org team IS visible (ORG_ADMINS_CAN_SEE_ALL_USERS enabled + membership in org_b),
        but the permission check on the target org prevents the assignment."""
        org_b = Organization.objects.create(name='org-b')
        team_b = Team.objects.create(name='team-in-org-b', organization=org_b)
    ...
    def test_superuser_can_always_assign_org_role_to_cross_org_team(self, admin_api_client, organization, org_member_rd):
        """Superusers are never filtered by ORG_ADMINS_CAN_SEE_ALL_USERS and can assign
    ...
    def test_org_admin_escalation_flow(self, user, user_api_client, organization, org_member_rd, org_admin_rd):
        ...
        # Give org admin on org_b so user can see team_b via ORG_ADMINS_CAN_SEE_ALL_USERS.
