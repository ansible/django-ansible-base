...
router.register(r'deprecated_endpoint', views.DeprecatedEndpointViewSet, basename='deprecated_endpoint')
router.register(r'conditional_deprecation', views.ConditionalDeprecationViewSet, basename='conditional_deprecation')
router.register(r'legacy_deprecated', views.LegacyDeprecatedViewSet, basename='legacy_deprecated')
